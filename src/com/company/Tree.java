...
public class Tree<T> implements DefaultBinaryTree<T> {
    public static double min = 10000;
    ...
    public static void findMinElement(String notationTree) throws Exception {
        ...
        System.out.print("Минимальный элемент равен: " + String.valueOf(min));
    }
}
